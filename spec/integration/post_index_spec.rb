...
RSpec.describe 'Post index page', type: :feature do
  before(:each) do
    @user = User.create(name: 'Osvaldo', bio: 'Aspiring FullStack Dev', photo: 'https://unsplash.com/photos/iR3dtvKmwAw',
                        posts_counter: 2)
    @user2 = User.create(name: 'Daniel', bio: 'FullStack Dev', photo: 'https://unsplash.com/photos/hodKTZow_Kk',
                         posts_counter: 2)
